...
class $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    emit(event, ...args) {
        ...
        if (callbacks)
            for (let callback of callbacks) callback.apply(this, args);
   ...
   */ drop(
    ...
    addedfile(file) {
        ...
        if (this.previewsContainer && !this.options.disablePreviews) {
            file.previewElement = $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    getFallbackForm() {
        ...
        let fields = $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(
            fieldsString
        );
        if (this.element.tagName !== "FORM") {
    ...
    cancelUpload(file) {
        if (
            ...
            for (let groupedFile of groupedFiles)
                groupedFile.status =
                    $3ed269f2f0fb224b$export$2e2bcd8739ae039.CANCELED;
    ...
    _uploadData(files, dataBlocks) {
        ...
        if (this.options.headers)
            $ewBKy$justextend(headers, this.options.headers);
    ...
    constructor(el, options) {
        ...
        if (this.options.previewsContainer !== false) {
            if (this.options.previewsContainer)
                this.previewsContainer = $3ed269f2f0fb224b$export$2e2bcd8739ae039.getElement(
        ...
        if (this.options.clickable) {
            if (this.options.clickable === true)
                ...
                this.clickableElements = $3ed269f2f0fb224b$export$2e2bcd8739ae039.getElements(
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.discover = function() {
    ...
    return (() => {
        ...
        for (let dropzone of dropzones) // Create a dropzone unless auto discover has been disabled for specific element
            if (
                $3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement(
                    dropzone
                ) !== false
            )
                result.push(
                    new $3ed269f2f0fb224b$export$2e2bcd8739ae039(dropzone)
                );
            else result.push(undefined);
        return result;
    })();
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.SUCCESS = "success"; // Detecting vertical squash in loaded image.
/*
...
class $3ed269f2f0fb224b$var$ExifRestore {
    ...
    static insertExif(resizedFileBase64, exifArray) {
        let imageData = resizedFileBase64.replace(
...
$3ed269f2f0fb224b$var$ExifRestore.initClass(); // @win window reference
/*
 * contentloaded.js
 *
